...
export const Login = () => {
    let auth = useAuth();
    let manageAccountLink = `${OidcConfig.authority}/Identity/Account/Manage`;
    let registerAccountLink = `${OidcConfig.authority}/Identity/Account/Register`;
            ...
            <ul className="navbar-nav">
                <li className="nav-item">
                    <a className="nav-link text-dark" href={manageAccountLink}>
                        <img src="/default_user_avatar.png" alt="user_avatar" width="30" height="30" />
